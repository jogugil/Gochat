...
var PullConsumerMessagesImpl = class extends QueuedIteratorImpl {
  constructor(c, opts, refilling = false) {
    ...
    __publicField(this, "abortOnMissingResource");
...
var OrderedPullConsumerImpl = class {
  ...
  async resetConsumer(seq = 0) {
    ...
    for (let i = 0; ; i++) {
      try {
        ...
        if (err.message === "stream not found") {
          (_c = this.iter) == null ? void 0 : _c.notify(ConsumerEvents.StreamNotFound, i);
          if (this.type === PullConsumerType.Fetch || this.opts.abort_on_missing_resource === true) {
            (_d = this.iter) == null ? void 0 : _d.stop(err);
            return Promise.reject(err);
          }
        }
        if (seq === 0 && i >= 30) {
  ...
  async reset(opts = {
    ...
    if (this.type === PullConsumerType.Fetch && orderedReset) {
      (_a = this.iter) == null ? void 0 : _a.src.stop();
      await ((_b = this.iter) == null ? void 0 : _b.closed());
      this.currentConsumer = null;
      return;
    }
  ...
  notifyOrderedResetAndReset() {
    var _a;
    (_a = this.iter) == null ? void 0 : _a.notify(ConsumerDebugEvents.Reset, "");
  ...
  async getBatch(stream, opts) {
    ...
    (async () => {
      ...
      for await (const m of raw) {
        if (!gotFirst) {
          gotFirst = true;
          const code2 = ((_a = m.headers) == null ? void 0 : _a.code) || 0;
          if (code2 !== 0 && code2 < 200 || code2 > 299) {
            badRequest = (_b = m.headers) == null ? void 0 : _b.description.toLowerCase();
            break;
          }
          const v = (_c = m.headers) == null ? void 0 : _c.get("Nats-Num-Pending");
          if (v === "") {
            badServer = true;
            break;
          }
  ...
  _setupHbMonitoring(millis2, cancelAfter = 0) {
    ...
    const handler = (v) => {
      ...
      if (!ordered) {
        ...
        (_d = this.monitor) == null ? void 0 : _d.restart();
        return false;
      }
