...
var require_errors = __commonJS({
  ...
  Caused by: ${e.stack}`;
    ...
    var KafkaJSAlterPartitionReassignmentsError = class extends KafkaJSProtocolError {
    ...
    var KafkaJSNoBrokerAvailableError = class extends KafkaJSError {
      constructor() {
...
var require_apiKeys = __commonJS({
  "node_modules/kafkajs/src/protocol/requests/apiKeys.js"(exports, module) {
    module.exports = {
      ...
      DescribeConfigs: 32,
      AlterConfigs: 33,
      // ApiVersions v0 and v1 on Kafka 0.11
  ...
  "node_modules/kafkajs/src/utils/long.js"(exports, module) {
    var Long = class _Long {
      ...
      static fromInt(value) {
        if (isNaN(value)) return _Long.ZERO;
        return new _Long(BigInt.asIntN(64, BigInt(value)));
      }
      /**
       * @param {number} value
       * @returns {!Long}
      ...
      static fromValue(val) {
        ...
        if (typeof val === "bigint") return new _Long(val);
        if (this.isLong(val)) return new _Long(BigInt(val.value));
        return new _Long(BigInt(val));
      }
      /**
       * @param {string} str
       * @returns {!Long}
       ...
       */
      shiftLeft(numBits) {
        return new _Long(this.value << BigInt(numBits));
      }
      /**
      ...
      or(other) {
        ...
        return _Long.fromBits(this.value | other.value);
      }
      /**
      ...
      xor(other) {
        if (!_Long.isLong(other)) other = _Long.fromValue(other);
        return new _Long(this.value ^ other.value);
      }
      /**
      ...
      shiftRightUnsigned(numBits) {
        return new _Long(this.value >> BigInt.asUintN(64, BigInt(numBits)));
      }
      /**
       ...
       */
      add(addend) {
        if (!_Long.isLong(addend)) addend = _Long.fromValue(addend);
        return new _Long(this.value + addend.value);
      }
      /**
       ...
       */
      subtract(subtrahend) {
        if (!_Long.isLong(subtrahend)) subtrahend = _Long.fromValue(subtrahend);
       ...
       */
      multiply(multiplier) {
        if (this.isZero()) return _Long.ZERO;
        if (!_Long.isLong(multiplier)) multiplier = _Long.fromValue(multiplier);
        return new _Long(this.value * multiplier.value);
      }
      /**
       ...
       */
      divide(divisor) {
        if (!_Long.isLong(divisor)) divisor = _Long.fromValue(divisor);
        if (divisor.isZero()) throw Error("division by zero");
        return new _Long(this.value / divisor.value);
      }
      /**
       ...
       */
      negate() {
        if (this.equals(_Long.MIN_VALUE)) {
...
var require_error = __commonJS({
  "node_modules/kafkajs/src/protocol/error.js"(exports, module) {
    ...
    var staleMetadata = (e) => ["UNKNOWN_TOPIC_OR_PARTITION", "LEADER_NOT_AVAILABLE", "NOT_LEADER_FOR_PARTITION"].includes(
      e.type
    );
    module.exports = {
      failure,
...
var require_v03 = __commonJS({
  "node_modules/kafkajs/src/protocol/recordBatch/record/v0/index.js"(exports, module) {
    ...
    module.exports = ({ offsetDelta = 0, timestampDelta = 0, key, value, headers = {} }) => {
      const headersArray = Object.keys(headers).flatMap(
        (headerKey) => !Array.isArray(headers[headerKey]) ? [{ key: headerKey, value: headers[headerKey] }] : headers[headerKey].map((headerValue) => ({ key: headerKey, value: headerValue }))
      );
...
var require_response9 = __commonJS({
  "node_modules/kafkajs/src/protocol/requests/fetch/v0/response.js"(exports, module) {
    ...
    var { code: OFFSET_OUT_OF_RANGE_ERROR_CODE } = errorCodes.find(
...
var require_response21 = __commonJS({
  "node_modules/kafkajs/src/protocol/requests/listOffsets/v0/response.js"(exports, module) {
    ...
    var parse = async (data) => {
      const partitionsWithError = data.responses.flatMap(
        (response) => response.partitions.filter((partition) => failure(partition.errorCode))
      );
...
var require_response49 = __commonJS({
  "node_modules/kafkajs/src/protocol/requests/joinGroup/v4/response.js"(exports, module) {
    ...
    var { failure, createErrorFromCode, errorCodes } = require_error();
    var { code: MEMBER_ID_REQUIRED_ERROR_CODE } = errorCodes.find(
  ...
  "node_modules/kafkajs/src/protocol/requests/alterPartitionReassignments/v0/response.js"(exports, module) {
    ...
    var parse = async (data) => {
      ...
      const topicPartitionsWithError = data.responses.flatMap(
        ({ partitions, topic }) => partitions.filter((partition) => failure(partition.errorCode)).map((partition) => ({
          ...partition,
          topic
        }))
      );
      if (topicPartitionsWithError.length > 0) {
        throw new KafkaJSAggregateError(
          ...
          topicPartitionsWithError.map(
            ({ topic, partition, errorCode }) => new KafkaJSAlterPartitionReassignmentsError(
  ...
  "node_modules/kafkajs/src/broker/index.js"(exports, module) {
    ...
    module.exports = class Broker {
      ...
      async joinGroup({
        ...
        const makeRequest = (assignedMemberId = memberId) => this[PRIVATE.SEND_REQUEST](
          joinGroup({
            groupId,
            sessionTimeout,
            rebalanceTimeout,
  ...
  "node_modules/kafkajs/src/cluster/brokerPool.js"(exports, module) {
    ...
    module.exports = class BrokerPool {
      ...
      async refreshMetadataIfNecessary(topics) {
        const shouldRefresh = this.metadata == null || this.metadataExpireAt == null || Date.now() > this.metadataExpireAt || !topics.every(
          (topic) => this.metadata.topicMetadata.some((topicMetadata) => topicMetadata.topic === topic)
        );
        if (shouldRefresh) {
  ...
  "node_modules/kafkajs/src/broker/saslAuthenticator/scram.js"(exports, module) {
    ...
    var SCRAM = class _SCRAM {
      ...
      constructor(sasl, host, port, logger, saslAuthenticate, digestDefinition) {
        ...
        this.currentNonce = _SCRAM.nonce();
      }
      async authenticate() {
        const { PREFIX } = this;
      ...
      async clientProof(clientMessageResponse) {
        ...
        return encode64(_SCRAM.xor(clientKey, clientSignature));
      }
      /**
       * @private
       */
      ...
      async saltPassword(clientMessageResponse) {
        ...
        const iterations = parseInt(clientMessageResponse.i, 10);
        return _SCRAM.hi(this.encodedPassword(), salt, iterations, this.digestDefinition);
      }
      /**
       * @private
       */
      ...
      encodedUsername() {
        ...
        return _SCRAM.sanitizeString(username).toString("utf-8");
      }
      /**
       * @private
       */
        ...
        if (Array.isArray(brokers2)) {
          ...
          brokers2.forEach((broker, index2) => {
            if (!isValidBroker(broker)) {
              throw new KafkaJSNonRetriableError(
                `Failed to connect: broker at index ${index2} is invalid "${typeof broker}"`
              );
            }
          });
        }
      ...
      async fetchTopicsOffset(topics) {
        ...
        for (const topicData of topics) {
          ...
          keys(partitionsPerLeader).forEach((nodeId) => {
            ...
            partitionsPerBroker[nodeId][topic] = partitions.filter(
              (p) => partitionsPerLeader[nodeId].includes(p.partition)
            );
          });
        }
...
var require_randomBytes = __commonJS({
  "node_modules/kafkajs/src/producer/partitioners/legacy/randomBytes.js"(exports, module) {
    ...
    if (global && global.crypto) {
      ...
      cryptoImplementation = require_crypto();
    }
    var MAX_BYTES = 65536;
    module.exports = (size) => {
      if (size > MAX_BYTES) {
  ...
  "node_modules/kafkajs/src/consumer/offsetManager/index.js"(exports, module) {
    ...
    module.exports = class OffsetManager {
      ...
      countResolvedOffsets() {
        ...
        const subtractPartitionOffsets = (resolvedTopicOffsets, committedTopicOffsets) => keys(resolvedTopicOffsets).map(
          (partition) => subtractOffsets(resolvedTopicOffsets[partition], committedTopicOffsets[partition])
        );
  ...
  "node_modules/kafkajs/src/consumer/batch.js"(exports, module) {
    ...
    module.exports = class Batch {
      constructor(topic, fetchedOffset, partitionData) {
        ...
        this.messagesWithinOffset = this.rawMessages.filter(
          (message) => Long.fromValue(message.offset).gte(longFetchedOffset)
        );
  ...
  "node_modules/kafkajs/src/consumer/assignerProtocol.js"(exports, module) {
    ...
    var MemberAssignment = {
      ...
      encode({ version, assignment, userData = Buffer.alloc(0) }) {
        return new Encoder().writeInt16(version).writeArray(
          Object.keys(assignment).map(
            (topic) => new Encoder().writeString(topic).writeArray(assignment[topic])
          )
    ...
    module.exports = class ConsumerGroup {
      ...
      async [PRIVATE.JOIN]() {
        ...
        const groupData = await this.coordinator.joinGroup({
          ...
          groupProtocols: this.assigners.map(
            (assigner) => assigner.protocol({
        ...
        try {
          ...
          const requests = topicPartitions.map(({ topic, partitions }) => ({
            ...
            partitions: partitions.filter(
              (partition) => (
                 ...
                 */
                committedOffsets[topic][partition] != null && activeTopicPartitions[topic].has(partition)
              )
            ).map((partition) => ({
              partition,
          ...
          return responses.flatMap(({ topicName, partitions }) => {
            ...
            return partitions.filter(
              ({ partition }) => !this.seekOffset.has(topicName, partition) && !this.subscriptionState.isPaused(topicName, partition)
            ).map((partitionData) => {
              ...
              const partitionRequestData = topicRequestData.partitions.find(
                ({ partition: partition2 }) => partition2 === partitionData.partition
              );
  ...
  "node_modules/kafkajs/src/consumer/fetchManager.js"(exports, module) {
    ...
    var createFetchManager = ({
      ...
      const createFetchers = () => {
        ...
        const fetchers2 = nodeIds.map(
          (nodeId) => createFetcher({
            nodeId,
            workerQueue,
            partitionAssignments,
            fetch: async (nodeId2) => {
...
var require_consumer = __commonJS({
  "node_modules/kafkajs/src/consumer/index.js"(exports, module) {
    ...
    module.exports = ({
      ...
      const instrumentationEmitter = rootInstrumentationEmitter || new InstrumentationEventEmitter();
      const assigners = partitionAssigners.map(
        (createAssigner) => createAssigner({ groupId, logger, cluster })
      );
      const topics = {};
      let runner = null;
...
var require_admin = __commonJS({
  "node_modules/kafkajs/src/admin/index.js"(exports, module) {
    ...
    var indexByPartition = (array) => array.reduce(
    ...
    module.exports = ({
      ...
      const setOffsets = async ({ groupId, topic, partitions }) => {
        ...
        return new Promise((resolve, reject) => {
          consumer.on(
            ...
            async () => consumer.stop().then(resolve).catch(reject)
          );
          consumer.run({
        ...
        return retrier(async (bail, retryCount, retryTime) => {
          try {
            ...
            const responseResources = responses.reduce(
              (result, { resources: resources2 }) => [...result, ...resources2],
              []
            );
      ...
      const alterConfigs = async ({ resources, validateOnly }) => {
        ...
        const invalidConfigValue = resources.find(
          (r) => r.configEntries.some((e) => typeof e.name !== "string" || typeof e.value !== "string")
        );
      ...
      const describeGroups = async (groupIds) => {
        ...
        const responses = await Promise.all(
          groupsByCoordinator.map(async ({ coordinator, groupIds: groupIds2 }) => {
            const retrier = createRetry(retry);
        ...
        return retrier(async (bail, retryCount, retryTime) => {
          try {
            ...
            for (const groupId of clonedGroupIds) {
              ...
              if (brokersPerGroups[broker.nodeId] === void 0) brokersPerGroups[broker.nodeId] = [];
            ...
            const errors = res.flatMap(
              ({ results: results2 }) => results2.map(({ groupId, errorCode, error }) => {
        ...
        return retrier(async (bail) => {
          try {
            ...
            const brokerRequests = entries(seekEntriesByBroker).map(
              ([nodeId, { topic: topic2, partitions: partitions2 }]) => async () => {
                const broker = await cluster.findBroker({ nodeId });
      ...
      const deleteAcls = async ({ filters }) => {
        ...
        if (filters.some(
          ({ resourceName }) => typeof resourceName !== "string" && typeof resourceName !== "undefined"
        )) {
          throw new KafkaJSNonRetriableError(
      ...
      const alterPartitionReassignments = async ({ topics, timeout }) => {
        ...
        for (const { topic, partitionAssignment } of topics) {
          ...
          for (const { partition, replicas } of partitionAssignment) {
            if (partition === null || partition === void 0 || typeof partition !== "number" || partition < 0) {
              throw new KafkaJSNonRetriableError(
...
export default require_kafkajs();
