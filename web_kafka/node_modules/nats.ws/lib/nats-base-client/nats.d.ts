import { ProtocolHandler } from "nats.ws/lib/nats-base-client/protocol";
import { ServiceClient } from "nats.ws/lib/nats-base-client/types";
import type { SemVer } from "nats.ws/lib/nats-base-client/semver";
import { Features } from "nats.ws/lib/nats-base-client/semver";
import { JetStreamClient, JetStreamManager } from "nats.ws/lib/jetstream/types";
import { ConnectionOptions, Context, JetStreamManagerOptions, JetStreamOptions, Msg, NatsConnection, Payload, PublishOptions, QueuedIterator, RequestManyOptions, RequestOptions, ServerInfo, Service, ServiceConfig, ServicesAPI, Stats, Status, Subscription, SubscriptionOptions } from "nats.ws/lib/nats-base-client/core";
